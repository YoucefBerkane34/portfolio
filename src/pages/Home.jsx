      ...
      {lines.map((line, i) => (
        <div key={i} style={{
          color: line.startsWith("$")
            ? t.accent
            : line.startsWith(">")
              ? (theme === "colorful" ? t.accentSecondary : "#7ee787")
              : "#94a3b8",
          opacity: 0,
...
const gradientText = (accent, accent2, theme) => {
  const useGradient = theme === "dark" || theme === "colorful";

  if (!useGradient) {
    return {
      color: "var(--text)", // safe fallback
      ...
      <section style={{
        ...
        <div style={{ flex: "1 1 340px" }}>
          ...
          <h1 style={{
            ...
            Hi, I'm{" "}
            <span style={gradientText(t.accent, t.accentSecondary, theme)}>
              Youcef
            </span>
          </h1>
          ...
          {stats.map(s => (
            <div key={s.label} style={{ textAlign: "center" }}>
              <div style={{
                ...
                fontWeight: 800,
                letterSpacing: -1,
                ...gradientText(t.accent, t.accentSecondary, theme),
              }}>
                {s.value}
              </div>
              <div style={{
